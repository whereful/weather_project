...
public class DiaryController {
    ...
    void createDiary(
            ...
            @Parameter(description = "날짜 형식 : yyyy-MM-dd") LocalDate date,
    ...
    List<Diary> readDiaries(
            @RequestParam
            @DateTimeFormat(iso = DateTimeFormat.ISO.DATE)
            @Parameter(description = "날짜 형식 : yyyy-MM-dd") LocalDate startDate,
            @RequestParam
            @DateTimeFormat(iso = DateTimeFormat.ISO.DATE)
            @Parameter(description = "날짜 형식 : yyyy-MM-dd") LocalDate endDate) {
